<template>
	<div class="list" v-if="mGlobal.url.params.ty === 'list'&&mData.ty">
		<em v-for="item in listTypes" :key="item[0]" @click="mData.ty.ll=item[0]"
			:class="{cur:mData.ty.ll===item[0]}"> {{item[1]}} </em>
		<saSearch></saSearch>
